...
<head>
  ...
  <title>مطعم الفخامة -فئات الأطباق</title>
...
<body id="top">
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="menuCategory.php" class="navbar-link hover-underline active">
              <div class="separator"></div>
  ...
  <main>
    <article>
      ...
      <!-- جميع الفئات -->
      <section class="section menu" aria-label="menu-label" id="menu" style="padding-top: 20%;">
        <div class="container">

          <p class="section-subtitle text-center label-2">اختيارات مميزة</p>

          <h2 class="headline-1 section-title text-center">جميع الفئات</h2>
          ...
          <ul class="grid-list ">
            ...
            <li>
              <div class="menu-card hover:card hover-underline">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/juices/mango.png" width="100" height="100" loading="lazy" alt="Tokusen Wagyu"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="juices.php" class="card-title">العصائر</a>
                    </h3>
                  </div>

                  <p class="card-text label-1">
                    انتعاش طبيعي مع كل رشفة، عصائر طازجة وكوكتيلات مبتكرة تمنحك مزيجًا من الطعم والفائدة.
                  </p>
            ...
            <li>
              <div class="menu-card hover:card hover-underline">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/sweets/konafa.png" width="100" height="100" loading="lazy" alt="Tokusen Wagyu"
                    class="img-cover">
                </figure>
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    <h3 class="title-3">
                      <a href="sweets.php" class="card-title">الحلويات</a>
                    </h3>
                  </div>

                  <p class="card-text label-1">
                    لمسة ختام ساحرة لوجبتك، نقدم لك أشهى الحلويات اليمنية والشرقية بطابع أصيل ونكهات غنية تذوب في الفم.
                  </p>
