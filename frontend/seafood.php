...
<head>
  ...
  <title>مطعم الفخامة -مأكولات بحرية</title>
    ...
    <article>
      ...
      <section class="section menu" aria-label="menu-label" id="menu" style="padding-top: 300px;">
        <div class="container">
          ...
          <h2 class="headline-1 section-title text-center">المأكولات البحرية</h2>
          <ul class="grid-list">
      ...
      <section class="section menu" aria-label="menu-label" id="menu" style="padding-top: 300px;">
        <div class="container">
          ...
          <h2 class="headline-1 section-title text-center">الأطباق البحرية</h2>
          <ul class="grid-list">
            <?php if (!empty($products)): foreach ($products as $p):
                $img = $p['image'] ?? '';
                if (strpos($img, '../') === 0) $img = substr($img, 3);
