...
<head>
  ...
  <title>مطعم الفخامة-الحجز</title>
        ...
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <?php if(isset($_GET['success'])): ?>
                <div style="color:green;padding:10px;border:1px solid #0a0;margin-bottom:10px">تم استلام الحجز بنجاح. سنقوم بالتواصل معك.</div>
                <?php elseif(isset($_GET['error'])): ?>
                <div style="color:red;padding:10px;border:1px solid #a00;margin-bottom:10px"><?= htmlspecialchars($_GET['error']) ?></div>
                <?php endif; ?>
