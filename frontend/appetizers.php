...
<head>
  ...
  <title>مطعم الفخامة -المقبلات</title>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="appetizers.php" class="navbar-link hover-underline active">
              <div class="separator"></div>
    ...
    <article>
      ...
      <section class="section menu" aria-label="menu-label" id="menu" style="padding-top: 300px;">
        <div class="container">
          ...
          <h2 class="headline-1 section-title text-center">المقبلات</h2>
          <ul class="grid-list">
