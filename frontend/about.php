...
<head>
  ...
  <title>مطعم الفخامة-من نحن</title>
...
<body id="top">
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="about.php" class="navbar-link hover-underline active">
              <div class="separator"></div>
  ...
  <!--قسم من نحن -->
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about" style="padding-top: 300px;">
        <div class="container">
